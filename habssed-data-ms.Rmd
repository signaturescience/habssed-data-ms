...
All sequencing data is available in the Sequence Read Archive (SRA) at accession **fixme**. Table 1 provides a subset of the metadata associated with these samples. The full metadata is available on the SRA bioproject page.
